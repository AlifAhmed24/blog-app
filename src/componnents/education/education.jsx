    ...
    const fetchLatest = async () => {
      try {
        ...
        const latest = await axios.get(
          "http://localhost:8800/api/article/get/category/Education"
        );
        setLatest(latest.data);
        const mostViews = await axios.get(
          "http://localhost:8800/api/article/get/category/Education/views"
        );
        setMostViews(mostViews.data);
        const all = await axios.get(
          "http://localhost:8800/api/article/getAll/category/Education/views"
        );
