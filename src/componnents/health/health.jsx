    ...
    const fetchLatest = async () => {
      try {
        ...
        const latest = await axios.get(
          `${process.env.REACT_APP_API_URL}article/get/category/Health`
        );
        setLatest(latest.data);
        const mostViews = await axios.get(
          `${process.env.REACT_APP_API_URL}article/get/category/Health/views`
        );
        setMostViews(mostViews.data);
        const all = await axios.get(
          `${process.env.REACT_APP_API_URL}article/getAll/category/Health/views`
        );
