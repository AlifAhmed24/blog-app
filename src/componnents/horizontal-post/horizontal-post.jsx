...
function HorizontalPost() {
  return (
    <a href="#" className="horizontalPost">
      <div className="thumbnail">
        <img src="https://img.freepik.com/free-vector/illustration-passion_53876-17884.jpg" alt="" />
      </div>
      <div className="info">
        <div className="writer">
            <span>Writter</span>
            <div className="writterAvatar">
            ...
            <span>Alif Ahmed</span>
        </div>
        
        <h1>Quick Tips for Maintaining a Healthy Lifestyle</h1>
        <p>The Internet is full of health advice. Some of it is true and some fake, and some feels very difficult, while other appears a bit too simple to be true.
        The Internet is full of health advice. while other appears a bit too simple to be true.
        </p>
      </div>
    </a>
  );
