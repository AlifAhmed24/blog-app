    ...
    const fetchLatest = async () => {
      try {
        ...
        const latest = await axios.get(
          `${process.env.REACT_APP_API_URL}article/get/category/Technology`
        );
        setLatest(latest.data);
        const mostViews = await axios.get(
         `${process.env.REACT_APP_API_URL}article/get/category/Technology/views`
        );
        setMostViews(mostViews.data);
        const all = await axios.get(
          `${process.env.REACT_APP_API_URL}article/getAll/category/Technology/views`
        );
